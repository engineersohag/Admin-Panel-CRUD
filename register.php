                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password" name="con_password">
                                    </div>
                                </div>
...
if (isset($_POST['register'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO `user_info` (`name`, `email`, `password`) VALUES ('$full_name', '$email', '$hashed_password')";
